...
class ChiSiamoModel {
    public function getData() {
        return [
            'title' => 'Chi Siamo',
            'header' => 'Chi Siamo',
            'content1' => '<h3>Benvenuti nel nostro mondo gaming!</h3>
                <p>Siamo un negozio <span lang="en">online</span> specializzato nel settore <span lang="en">gaming</span>, con la passione per i videogiochi e tutto ciò che riguarda il mondo del <span lang="en">gaming</span> digitale.</p>',
            ...
            'content6' => '<h3>La Nostra Missione</h3>
                <p>La nostra missione è rendere il <span lang="en">gaming</span> accessibile a tutti, offrendo prodotti di qualità, servizi personalizzati e un\'assistenza clienti impeccabile. Ci impegniamo a creare una comunità di appassionati, dove condividere esperienze e scoprire nuove avventure nel mondo dei videogiochi.</p>',
                
            'content7' => '<h3>Perché Sceglierci</h3>
                <ul>
                ...
                <p>Vieni a trovarci <span lang="en">online</span> o contattaci per qualsiasi informazione. Siamo qui per rendere la tua esperienza di <span lang="en">gaming</span> indimenticabile!</p>'
        ];
    }
}
?>