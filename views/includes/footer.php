...
<link rel="stylesheet" href="assets/css/style.css">
    <section class="footer-content">
        <section class="footer-section">
            ...
            <p><i class="fas fa-map-marker-alt" aria-hidden="true"></i> <span class="sr-only">Indirizzo:</span> Via Trieste, 63, 35131 Padova PD</p>
            ...
            <p><i class="fas fa-envelope" aria-hidden="true"></i> <span class="sr-only">Email:</span> <a href="mailto:info@tecwebz25.it" aria-label="Invia un'email al nostro indirizzo">info@tecwebz25.it</a></p>
        </section>
        
        <section class="footer-section">
            <h4 id="hours-heading">Orari Negozio</h4>
            <p><i class="fas fa-clock" aria-hidden="true"></i> <span class="sr-only">Orario:</span> Lun-Ven: 9:00 - 19:00</p>
