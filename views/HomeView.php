        ...
        <div id="red-section">
            <div class="content illustrated-title">
                ...
                <div aria-hidden="true">
                    <img src="assets/img/pages/nesexploded_white.webp" id="illustration" alt="Illustrazione piattaforma smontata"/>
                </div>
            </div>
        ...
        <div class="gray-section" id="ads" aria-label="Le nostre offerte">
            <div class="row content">
                <div class="main-card ad-card">
                    <div class="crt-image">
                        <img src="assets/img/pages/copertina_negozio.webp" alt="Illustrazione telefono e pulsantiera"/>
                    </div>
                    <div class="ad-card-description">
                        <img src="assets/img/pages/arrowright_black.webp" class="arrow-small" alt="Vai allo shop" aria-hidden="true"/>
                ...
                <div class="main-card ad-card">
                    <div class="crt-image">
                        <img src="assets/img/pages/copertina_permuta.webp" alt="Illustrazione piattaforma con doppio schermo"/>
                    </div>
                    <div class="ad-card-description">
                        <img src="assets/img/pages/arrowright_black.webp" class="arrow-small" alt="Vai allo shop" aria-hidden="true"/>
                ...
                <div class="main-card ad-card">
                    <div class="crt-image">
                        <img src="assets/img/pages/copertina_chisiamo.webp" alt="Illustrazione stretta di mano tra due persone"/>
                    </div>
                    <div class="ad-card-description">
                        <img src="assets/img/pages/arrowright_black.webp" class="arrow-small" alt="Vai allo shop" aria-hidden="true"/>
